...
const products = [
  ...
  { id: 2, name: 'MANIFEST', description: 'The author emphasizes that acknowledging and understanding your fears is the first step in conquering them. She then offers practical exercises and techniques to help readers reframe their thought patterns, build self-confidence, and silence the inner critic, ultimately we dont feel we deserve to be loved.clearing the way to manifest their dreams and loved.', price: 45, image: product2Image },
  { id: 3, name: 'DO EPIC SHIT 3', description: '"Do Epic Shit" is a compelling guide that encourages us to push boundaries, shatter limitations, and achieve greatness in every aspect of our lives. It is not just a book;it is a roadmap to personal growth and success.it is a roadmap to personal growth and success. we dont feel we deserve to be loved.it is a roadmap to personal growth and success and strength.', price: 35, image: product3Image },
